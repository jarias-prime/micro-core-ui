---
title: Divide Colors
descripttion: These utility classes set divider colors for elements that use border dividers between child elements. Use them to ensure consistent divider color application across your UI.
outline: deep
---
