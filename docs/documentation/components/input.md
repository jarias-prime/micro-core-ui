...
Use the base `mc-input` when you need a generic editable field. Prefer a variant when:
...
<mc-input v-model="model" label="Text Input" placeholder="Enter your username" />
...
<mc-input v-model="inputValue.input3" label="Text Input" placeholder="Enter your username" active />

```vue
<template>
  <mc-input v-model="inputValue" label="Text Input" placeholder="Enter your username" active />
</template>
...
<mc-input v-model="inputValue.input4" label="Text Input" placeholder="Enter your username" :error="true">
  <template #icon>
...
```vue
<template>
  <mc-input v-model="inputValue" label="Text Input" placeholder="Enter your username" :error="true">
    <template #icon>
      <Icon icon="ph:warning-circle-fill" />
    </template>
  </mc-input>
...
<mc-input v-model="inputValue.input5" label="Text Input" placeholder="Enter your username" :disabled="true" />

```vue
<template>
  <mc-input v-model="inputValue" label="Text Input" placeholder="Enter your username" :disabled="true" />
</template>
...
<mc-input v-model="inputValue.input6" label="Text Input" placeholder="Enter your username" :min-length="0" :max-length="50" show-char-count />
...
<mc-input v-model="inputValue.input7" label="Text Input" placeholder="Enter your username"  >
  <template #prefix>
    <Icon icon="ph:warning-circle-fill" />
  </template>
</mc-input>
...
```vue
<template>
  <mc-input v-model="inputValue" label="Text Input" placeholder="Enter your username">
    <template #prefix>
      <Icon icon="ph:warning-circle-fill" />
    </template>
  </mc-input>
...
<div class="mc-flex mc-flex-col mc-gap-2">
  <mc-input v-model="inputValue.input6" label="Offset xs" placeholder="00" offset-size="xs" type="number">
    <template #trailing>
      minutes
    </template>
  </mc-input>

  <mc-input v-model="inputValue.input8" label="offset sm" placeholder="0000000" offset-size="sm" type="number">
    <template #trailing>
      minutes
    </template>
  </mc-input>

  <mc-input v-model="inputValue.input9" label="offset md" placeholder="Enter your name" offset-size="md" >
    <template #trailing>
      Name of the user
    </template>
  </mc-input>
...
<template>
  <!-- xs -->
  <mc-input v-model="inputValueXS" label="Offset xs" placeholder="00" offset-size="xs" type="number">
    <template #trailing> minutes </template>
  </mc-input>

  <!-- sm -->
  <mc-input v-model="inputValueSM" label="offset sm" placeholder="00" offset-size="sm" type="number">
    <template #trailing> minutes </template>
  </mc-input>

  <!-- md -->
  <mc-input v-model="inputValueMD" label="offset md" placeholder="Enter your name" offset-size="md">
...
```vue
<template>
  <mc-input v-model="inputValue" label="Text Input" placeholder="Enter your text">
    <template #helperMessage> This is a helper message </template>
  </mc-input>

  <mc-input v-model="inputValue" label="Text Input" placeholder="Enter your text" :error="true">
    <template #helperMessage>
      <icon icon="ph:warning-circle-fill" width="20px" height="20px" />
      <span>This is an error message</span>
    </template>
...
<div>
   <mc-input-search v-model="inputValue.input12" label="Search" placeholder="Search ..."/>
</div>

```vue
<template>
  <mc-input-search v-model="inputValueSearch" label="Search" placeholder="Search ..." />
</template>
...
<div>
  <mc-input-username v-model="inputValue.input13" label="Username" placeholder="Enter username" />
</div>

```vue
<template>
  <mc-input-username v-model="inputValueUsername" label="Username" placeholder="Enter username" />
</template>
...
<div>
  <mc-input-email v-model="inputValue.input14" label="Username" placeholder="Enter email" />
</div>

```vue
<template>
  <mc-input-email v-model="inputValueEmail" label="Username" placeholder="Enter email" />
</template>
...
<div>
  <form action="#">
    <mc-input-password v-model="inputValue.input15" label="Password" placeholder="Enter password" />
  </form>
</div>

```vue
<template>
  <mc-input-password v-model="inputValuePassword" label="Password" placeholder="Enter password" />
</template>
...
<div>
  <mc-input-url v-model="inputValue.input16" label="URL" placeholder="Enter url" />
</div>

```vue
<template>
  <mc-input-url v-model="inputValueURL" label="URL" placeholder="Enter url" />
</template>
...
<div>
  <mc-input-dropdown v-model="inputValue.input19" label="Dropdown Input" placeholder="Select an item ..." readonly />
</div>

```vue
<template>
  <mc-input-dropdown v-model="dropdownInput" label="Dropdown Input" placeholder="Select an item ..." readonly />
</template>
