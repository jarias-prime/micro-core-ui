...
const menuList = ref([
  {
    ...
    value: 'add',
    icon: 'ph:check',
    iconColor: 'mc-text-color-supporting',
    onClickFn: () => {
  ...
  },
  {
    ...
    value: 'delete',
    icon: 'ph:trash',
    textColor: 'mc-text-color-danger-base',
    onClickFn: () => {
...
```vue
<mc-button-dropdown dropdown-id="example2" v-model="selectedNeutral" :menu-list="menuList" tone="neutral">
  Neutral
</mc-button-dropdown>
<mc-button-dropdown dropdown-id="example3" v-model="selectedSuccess" :menu-list="menuList" tone="success">
  Success
</mc-button-dropdown>
```
...
```vue
<mc-button-dropdown v-model="selectedSmall" dropdown-id="example4" :menu-list="menuList" size="small">
  Small
</mc-button-dropdown>
<mc-button-dropdown v-model="selectedMedium" dropdown-id="example5" :menu-list="menuList">
  Medium
</mc-button-dropdown>
<mc-button-dropdown v-model="selectedLarge" dropdown-id="example6" :menu-list="menuList" size="large">
  Large
</mc-button-dropdown>
```
...
```vue
<mc-button-dropdown v-model="selectedPrimary" dropdown-id="example7" :menu-list="menuList" variant="primary">
  Primary
</mc-button-dropdown>
<mc-button-dropdown v-model="selectedSecondary" dropdown-id="example8" :menu-list="menuList" variant="secondary">
  Secondary
</mc-button-dropdown>
```
...
```vue
<mc-button-dropdown v-model="selectedDisabled" dropdown-id="example9" :menu-list="menuList" disabled>
  Disabled
</mc-button-dropdown>
<mc-button-dropdown
  v-model="selectedDisabled"
...
<script setup lang="ts">
import McButtonDropdown from "@/components/button/button-dropdown/button-dropdown.vue";
import { ref } from "vue";

const menuList = ref([
  { text: 'Add', value: 'add', icon:  'ph:check', iconColor: 'mc-text-color-supporting', onClickFn: () => {alert("Add was clicked.")}},
  { text: 'Delete', value: 'delete', icon: 'ph:trash', textColor: 'mc-text-color-danger-base', onClickFn: () => {alert("Delete was clicked.")} },
]);
