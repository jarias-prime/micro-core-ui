...
const lozengeTitle = {
  title: 'Active',
  tone: 'success',
  avatarUrl: 'https://iciw.centracdn.net/client/dynamic/images/12917_212b7a319e-13555-001-1-1350x0.jpg',
  fill: true,
...
const dataLozenge = [
  {
    ...
    lastUpdate: {
      ...
      subtext: 'Lorem ipsum dolor ',
      lozengeFill: true,
      lozengeAvatarUrl: 'https://iciw.centracdn.net/client/dynamic/images/12917_212b7a319e-13555-001-1-1350x0.jpg',
    },
  },
];
</script>
...
<table>
  ...
  <tbody>
    ...
    <tr>
    <td>headerDropdown</td>
    <td>
      <p>Property to configure the Table Header Dropdown.</p>
      <ul>
        <li><code>enabled</code> (boolean): When true, enable table header dropdown.</li>
        <li><code>hasSelectAll</code> (boolean, optional): When true, will render a functional Select All button.</li>
        <li><code>filterList</code> (MenuListType[], optional): Array of filter options for the table header dropdown. Provides a list of available filters that can be applied to the column.</li>
        <li><code>isSortable</code> (boolean, optional): When true, will show option to sort inside the dropdown.</li>
      </ul>
    </td>
    <td>{<br>
      enabled: boolean,<br>
      hasSelectAll?: string,<br>
      filterList?: MenuListType[]<br>
      isSortable?: boolean<br>
    }</td>
    <td>No</td>
    </tr>
  </tbody>
