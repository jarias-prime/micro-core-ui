...
<mc-modal v-model="modalModel" title="Select with Modal">
   <mc-select-multiple
...
For guidance on implementing error, active, and disabled states in the select component, you can refer to the documentation for the input text component, as the approach is similar. See the [Input Form](/documentation/components/input/input) for detailed instructions.
...
<div>
  <mc-select-multiple
    ...
    avatar-source="https://iciw.centracdn.net/client/dynamic/images/12917_212b7a319e-13555-001-1-1350x0.jpg"
  />
</div>
...
import McSelectMultiple from "@/components/select/select-multiple/select-multiple.vue";
