<template>
  <div class="ladderized-list mc-relative">
    <transition :name="transitionName" mode="out-in">
      <div :key="activeLevel">
        <mc-ladderized-list-back v-if="activeLevel > 0" :label="backLabel ?? 'Back'" @back="handleBackClick" />
        <mc-list
...
import McLadderizedListBack from './ladderized-list-back.vue';
